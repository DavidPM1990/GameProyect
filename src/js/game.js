...
const Game = {
    ...
    jumpAudio: new Audio("https://archive.org/download/jump_20210424/jump.wav"),
    floor: undefined,
    gameOver: new Audio("https://ia601504.us.archive.org/9/items/mixkit-failure-arcade-alert-notification-240/mixkit-failure-arcade-alert-notification-240.mp3"),
    ...
    init() {
        ...
        this.finalScreen.src = "src/img/gameover_photo.jpg"
    ...
    start() {
        ...
        this.animationId = setInterval(() => {
            ...
            console.log('QUE HAY AQUI-->', this.player.velY)
    ...
    setEventListener() {
        addEventListener('keydown', ({ code }) => {
            switch (code) {
                case 'ArrowUp':
                    if (this.player.velY === 0) this.player.velY -= 10
    ...
    // gameOver() {
    //     this.finalScreen = new Image()
    //     this.finalScreen.src = "/src/img/geometry-dash-icon-download-3.jpg"
